...
public class ViewMenuDownload extends JPanel {
    ...
    public Object namaKolom[] = {"Judul", "Genre", "Download"};

    public ViewMenuDownload(Akun akun) {
        this.akun = akun;
        ...
        tabel = new JTable(mms.data1, namaKolom);
        ...
        jLabel1 = new JLabel("Nb: Click title to download anime");
