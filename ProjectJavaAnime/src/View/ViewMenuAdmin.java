...
public class ViewMenuAdmin extends JFrame {
    ...
    public ViewMenuShowAdmin vmsa;
    public ViewMenuTambahAdmin vmta;
    public ViewMenuAdminHapus vmah;
    public ViewMenuAdminUpdate vmau;
    ...
    public ViewMenuAdmin(Akun akun) {
        this.akun = akun;
        vmsa = new ViewMenuShowAdmin(akun);
        vmta = new ViewMenuTambahAdmin();
        vmah = new ViewMenuAdminHapus(akun);
        vmau = new ViewMenuAdminUpdate(akun);
        ...
        jButton5.setFont(new java.awt.Font("Franklin Gothic Heavy", 0, 10)); 
        jButton5.setForeground(new java.awt.Color(51, 51, 51));
        jButton5.setText("DELETE");
        jButton5.setBorder(new SoftBevelBorder(BevelBorder.RAISED));

        jPanel1.add(jButton5);
        jButton5.setBounds(11, 163, 67, 19);
        ...
        jButton4.setBounds(11, 203, 67, 19);
        ...
        jLabel4.setText("ADMIN " + akun.getUsernameadmin());
    ...
    public void ShowMenuAdmin() {
        ...
        vmta.setVisible(false);
        vmah.setVisible(false);
        vmau.setVisible(false);
        add(vmsa);
        vmsa.setBounds(110, 30, 380, 300);
        vmsa.setVisible(true);
    }

    public void HomeMenu() {
        jPanel2.setVisible(true);
        vmsa.setVisible(false);
        vmta.setVisible(false);
        vmah.setVisible(false);
        vmau.setVisible(false);
    }
    ...
    public void ShowTambah() {
        ...
        vmau.setVisible(false);
        add(vmta);
        vmta.setBounds(110, 30, 380, 300);
        vmta.setVisible(true);
    }
    ...
    public void ShowUpdate() {
        ...
        vmah.setVisible(false);
        add(vmau);
        vmau.setBounds(110, 30, 380, 300);
        vmau.setVisible(true);
    }

    public void ShowHapus() {
        jPanel2.setVisible(false);
        vmsa.setVisible(false);
        vmta.setVisible(false);
        vmau.setVisible(false);
        add(vmah);
        vmah.setBounds(110, 30, 380, 300);
        vmah.setVisible(true);
    }
}
